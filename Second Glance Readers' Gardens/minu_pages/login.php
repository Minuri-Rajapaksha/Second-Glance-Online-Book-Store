...
<!-- end of content left -->
			...
			if($num==0)
				...
				if($num==1){
					...
					<a href=\"buy.html\"><h4> To buy books click here </h4></a>
					<a href=\"home.html\">  back to home    </a> ";
				}
				
				if($email == $admin && $password == $pword ){
					echo "<script type='text/javascript'>alert('Logged in as Administrator')</script> 
					<a href=\"edit.html\"><h4> To edit database click here </h4></a> 
					<a href=\"home.html\">  back to home    </a> ";
				}
